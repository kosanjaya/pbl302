      ...
      >
        ...
        <form id="form-register" action="{{ url('/api/register') }}" method="POST">
          <div class="relative mb-4">
            @csrf
            <input
              class="w-full bg-[#121312] outline-none border-b active:bg-[#121312] focus:valid:border-b focus:valid:border-b-[#52B788] focus:invalid:border-b focus:invalid:border-b-[#C52D2D] text-[#d8d8d8] text-[1rem] py-4 pr-2 pl-16"
              type="email"
              name="email"
              id="email"
              placeholder="Email"
          ...
          <div class="relative mb-4">
            <input
              class="password w-full bg-[#121312] outline-none border-b focus:valid:border-b focus:valid:border-b-[#52B788] focus:invalid:border-b focus:invalid:border-b-[#C52D2D] text-[#d8d8d8] text-[1rem] py-4 pr-2 pl-16"
              type="password"
              name="password"
          ...
          <div class="flex flex-col justify-center items-center">
            <p
              class="text-[#989898] text-[.85rem] font-['Montserrat'] font-medium tracking-wider mb-3"
            >
              Already have an account?
              <a href="{{url('/loginPage')}}" class="text-[#d8d8d8]">Login Here</a>
            </p>
            <button
              type="submit"
              id="register-button"
