...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>Landing Page Laporbug</title>
    @notifyCss
    <!-- CSS -->
  ...
  @endif
    ...
    <section class="container px-6">
      <div
        class="section--transition section--hidden flex flex-row lg:justify-around h-screen lg:items-center"
      >
        <div class="w-full lg:w-2/5 py-14 md:py-36">
          <p
            class="w-44 lg:w-52 bg-[#5A5A5A] text-[#d8d8d8] text-[0.85rem] lg:text-[1rem] font-['Montserrat'] font-extralight rounded-md text-center tracking-widest py-2"
          >
            PBO PBL-RKS302
          </p>
          <h1
            class="text-[#d8d8d8] text-[3rem] lg:text-[3.5rem] font-['Montserrat_Alternates'] font-semibold tracking-wider pt-3 pb-4"
          >
            Lapor Bug
          </h1>
          <p
            class="max-w-[60ch] text-[#d8d8d8] text-[1rem] lg:text-[1rem] font-['Montserrat'] font-normal tracking-wider leading-6"
          >
          ...
          <a href="{{url('/loginPage')}}">
            <button
              class="bg-[#1C1F1C] hover:bg-[#282F28] active:scale-95 text-[#d8d8d8] border-2 border-solid border-[#52B788] rounded-md tracking-wide py-2 px-8 mt-8"
              type="button"
            >
              Get Started
            </button>
        ...
        <div class="hidden lg:relative lg:w-2/5 lg:block">
          <img
            class="absolute scale-[2.5] xl:scale-[2.3] -top-8 -left-8 -z-10"
            src="src/img/landing_page/hero-backlight.png"
            width="450px"
            height="200px"
            alt=""
          />
      ...
      <img
        class="absolute -z-10 lg:hidden scale-[2.5] top-40 -right-52"
        src="src/img/landing_page/hero-backlight.png"
        width="450px"
        height="200px"
        alt=""
    ...
    <section class="container px-6 py-12 mt-20">
      <div class="section--transition">
        <h3
          class="text-[#d8d8d8] text-center text-[1.5rem] lg:text-[1.8rem] font-['Montserrat'] font-medium tracking-wider pb-4"
        >
          Fitur Aplikasi
        </h3>
        <div class="w-4/5 lg:w-2/5 mx-auto">
          ...
          >
            ...
            dan user-friendly
            <span class="text-[#d8d8d8] font-semibold tracking-wider"
      ...
      <div
        class="section--transition flex flex-wrap justify-center items-center gap-6 mb-12"
      >
        <!-- gap -->
        <div
          class="w-full max-w-[18rem] h-[18rem] hover:scale-110 transition-all duration-300 ease-out bg-[#121312] border border-[#d8d8d8] rounded-lg px-6"
        >
          <div class="w-full h-2/5 relative flex justify-center">
            <img
              class="absolute -top-[2rem] -left-[2rem] z-10"
              src="src/img/landing_page/fitur-items-backlight.png"
              alt=""
            />
            <img
              class="scale-[.6]"
          ...
          <div class="w-full h-3/5">
            <p
              class="text-[#d8d8d8] font-['Montserrat'] text-[1rem] text-center font-semibold tracking-wider pb-2"
            >
        ...
        >
          <div class="w-full h-2/5 relative flex justify-center">
            <img
              class="absolute -top-[2.5rem] -left-[2rem] z-10"
              src="src/img/landing_page/fitur-items-backlight.png"
              alt=""
            />
            <img
        ...
        >
          <div class="w-full h-2/5 relative flex justify-center">
            <img
              class="absolute -top-[4rem] left-[2.3rem] z-10"
              src="src/img/landing_page/fitur-items-backlight.png"
              alt=""
            />
            <img
    ...
    <section class="container px-6 py-12">
      <div class="section--transition">
        <h3
          class="text-[#d8d8d8] text-[1.5rem] lg:text-[1.8rem] lg:text-start font-['Montserrat_Alternates'] text-center font-medium tracking-wider pb-4"
        >
          Profil Pengembang
        </h3>
        <div class="flex justify-center lg:justify-start">
          <p
            class="max-w-[50ch] text-[#B6B6B6] text-[1rem] text-center lg:text-left font-['Montserrat'] font-normal tracking-wider pb-8"
          >
      ...
      <div class="section--transition flex flex-col justify-center mt-8 mb-12">
        ...
        <div class="flex flex-wrap justify-center gap-12 pt-8 mt-4">
          <!-- start -->
          <div
            class="w-full max-w-[15.8rem] h-[16.5rem] hover:scale-110 transition-all duration-300 ease-out bg-[#121312] border border-[#d8d8d8] rounded-lg px-[1.25rem] mb-6"
          >
            ...
            <div
              class="text-[#d8d8d8] text-[1rem] text-center font-['Montserrat'] -translate-y-12"
            >
          ...
          >
            ...
            <div
              class="text-[#d8d8d8] text-[1rem] text-center font-['Montserrat'] -translate-y-14"
            >
      ...
      <div class="section--transition flex flex-col justify-center mt-8 mb-12">
        ...
        <div class="flex flex-wrap justify-center gap-12 pt-8 mt-4">
          ...
          >
            ...
            <div
              class="text-[#d8d8d8] text-[1rem] text-center font-['Montserrat'] -translate-y-10"
            >
          ...
          >
            ...
            <div
              class="text-[#d8d8d8] text-[1rem] text-center font-['Montserrat'] -translate-y-8"
            >
    ...
    <section class="container px-6">
      <h3
        class="text-[#d8d8d8] text-center text-[1rem] font-['Montserrat'] font-medium tracking-wider pb-4"
      >
