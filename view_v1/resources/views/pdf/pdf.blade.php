      ...
      <div class="container">
        ...
        <table style="width:100%;"><!-- w-full -->
          ...
          <tr class="border">
            ...
            <td class="px-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras nec eros id ante ultrices pharetra. Proin semper fringilla metus, consequat auctor urna faucibusa a.</td>
          </tr>
          <tr class="border">
            <td class="p-2">URL</td>
